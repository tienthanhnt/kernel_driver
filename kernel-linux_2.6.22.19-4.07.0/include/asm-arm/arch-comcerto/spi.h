/*
 * include/asm-arm/arch-comcerto/spi.h
 *
 ...
 */
#ifndef __ASM_ARCH_COMCERTO_SPI_H
#define __ASM_ARCH_COMCERTO_SPI_H

#ifdef CONFIG_ARCH_M823V2
#define COMCERTO_SPI_FIFO_DEPTH		128
#else
...
#endif /* __ASM_ARCH_COMCERTO_SPI_H */
